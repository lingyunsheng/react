  ...
  return (
    <div>
      ...
      <Row className="common-main" type="flex" justify="center">
        <Col className="common-left" xs={24} sm={24} md={18} lg={16} xl={14} >
            <List
              header={<div style={{marginLeft:'10px'}}>最新日志</div>}
              itemLayout="vertical"
              dataSource={mylist}
              renderItem={item => (
                <List.Item>
