...
declare type FormCreateOptionMessagesCallback = (...args: unknown[]) => string;
...
export declare type ValidationRule = {
    ...
    validator?: (rule: unknown, value: unknown, callback: unknown, source?: unknown, options?: unknown) => unknown;
};
...
export declare type WrappedFormUtils<V = unknown> = {
...
export interface FormComponentProps<V = unknown> extends WrappedFormInternalProps<V>, RcBaseFormProps {
    form: WrappedFormUtils<V>;
}
export default class Form extends React.Component<FormProps, any> {
    ...
    static create: <TOwnProps extends FormComponentProps<unknown>>(options?: FormCreateOption<TOwnProps>) => FormWrappedProps<TOwnProps>;
